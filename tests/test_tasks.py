...
def test_synchronizes_user_metadata(minimal_dump_json, users_with_identities, communities, search_clear):
...
def test_assigns_community_entitlements(minimal_dump_json, users_with_identities, communities, search_clear):
...
def test_assigns_role_entitlements(minimal_dump_json, users_with_identities, roles, search_clear):
...
def test_assigns_both_community_and_role_entitlements(
    minimal_dump_json, users_with_identities, communities, roles, search_clear
):
...
def test_user_with_no_valid_entitlements_has_empty_entitlements(minimal_dump_json, users_with_identities, search_clear):
...
def test_one_user_failure_does_not_prevent_syncing_other_users(
    minimal_dump_json, users_with_identities, communities, roles, search_clear, monkeypatch
):
...
def test_does_not_create_users_without_matching_identity(minimal_dump_json, database, search_clear):
